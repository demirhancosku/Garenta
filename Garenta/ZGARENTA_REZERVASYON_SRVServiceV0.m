...
- (ODataQuery *)getIT_EKSURUCUEntryQueryWithCinsiyet:(NSString *)Cinsiyet andFirstname:(NSString *)Firstname andLastname:(NSString *)Lastname andBirthdate:(NSString *)Birthdate andTckn:(NSString *)Tckn andTelno:(NSString *)Telno andUyruk:(NSString *)Uyruk andUlke:(NSString *)Ulke andEhliyetAlisyeri:(NSString *)EhliyetAlisyeri andEhliyetSinifi:(NSString *)EhliyetSinifi andEhliyetNo:(NSString *)EhliyetNo andEhliyetTarihi:(NSString *)EhliyetTarihi
{
	...
	NSString *relativePath = [NSString stringWithFormat:@"IT_EKSURUCU(Cinsiyet=%@,Firstname=%@,Lastname=%@,Birthdate=%@,Tckn=%@,Telno=%@,Uyruk=%@,Ulke=%@,EhliyetAlisyeri=%@,EhliyetSinifi=%@,EhliyetNo=%@,EhliyetTarihi=%@)", Cinsiyet, Firstname, Lastname, Birthdate, Tckn, Telno, Uyruk, Ulke, EhliyetAlisyeri, EhliyetSinifi, EhliyetNo, EhliyetTarihi];
	ODataQuery *query = [self getQueryForRelativePath:relativePath];
	return query;
}
...
- (ODataQuery *)getIT_EKSURUCUEntryQueryTypedWithCinsiyet:(NSString *)Cinsiyet andFirstname:(NSString *)Firstname andLastname:(NSString *)Lastname andBirthdate:(NSDate *)Birthdate andTckn:(NSString *)Tckn andTelno:(NSString *)Telno andUyruk:(NSString *)Uyruk andUlke:(NSString *)Ulke andEhliyetAlisyeri:(NSString *)EhliyetAlisyeri andEhliyetSinifi:(NSString *)EhliyetSinifi andEhliyetNo:(NSString *)EhliyetNo andEhliyetTarihi:(NSDate *)EhliyetTarihi
{
	...
	NSString *relativePath = [NSString stringWithFormat:@"IT_EKSURUCU(Cinsiyet=%@,Firstname=%@,Lastname=%@,Birthdate=%@,Tckn=%@,Telno=%@,Uyruk=%@,Ulke=%@,EhliyetAlisyeri=%@,EhliyetSinifi=%@,EhliyetNo=%@,EhliyetTarihi=%@)", CinsiyetUri, FirstnameUri, LastnameUri, BirthdateUri, TcknUri, TelnoUri, UyrukUri, UlkeUri, EhliyetAlisyeriUri, EhliyetSinifiUri, EhliyetNoUri, EhliyetTarihiUri];
	ODataQuery *query = [self getQueryForRelativePath:relativePath];
	return query;
}
...
- (ODataQuery *)getIT_FATURA_ADRESEntryQueryWithAdresKaydet:(NSString *)AdresKaydet andAdresTanim:(NSString *)AdresTanim andIlcekod:(NSString *)Ilcekod andAddrnumber:(NSString *)Addrnumber andTckn:(NSString *)Tckn andFirstname:(NSString *)Firstname andIlkodu:(NSString *)Ilkodu andLastname:(NSString *)Lastname andAdres:(NSString *)Adres andUlke:(NSString *)Ulke
{
	...
	Ulke = [ODataQuery encodeURLParameter:Ulke];
	NSString *relativePath = [NSString stringWithFormat:@"IT_FATURA_ADRES(AdresKaydet=%@,AdresTanim=%@,Ilcekod=%@,Addrnumber=%@,Tckn=%@,Firstname=%@,Ilkodu=%@,Lastname=%@,Adres=%@,Ulke=%@)", AdresKaydet, AdresTanim, Ilcekod, Addrnumber, Tckn, Firstname, Ilkodu, Lastname, Adres, Ulke];
	ODataQuery *query = [self getQueryForRelativePath:relativePath];
	return query;
}
...
- (ODataQuery *)getIT_FATURA_ADRESEntryQueryTypedWithAdresKaydet:(NSString *)AdresKaydet andAdresTanim:(NSString *)AdresTanim andIlcekod:(NSString *)Ilcekod andAddrnumber:(NSString *)Addrnumber andTckn:(NSString *)Tckn andFirstname:(NSString *)Firstname andIlkodu:(NSString *)Ilkodu andLastname:(NSString *)Lastname andAdres:(NSString *)Adres andUlke:(NSString *)Ulke
{
	...
	NSString *UlkeUri = [ODataQuery encodeURLParameter:[converter convertToEdmStringURI:Ulke]];
	NSString *relativePath = [NSString stringWithFormat:@"IT_FATURA_ADRES(AdresKaydet=%@,AdresTanim=%@,Ilcekod=%@,Addrnumber=%@,Tckn=%@,Firstname=%@,Ilkodu=%@,Lastname=%@,Adres=%@,Ulke=%@)", AdresKaydetUri, AdresTanimUri, IlcekodUri, AddrnumberUri, TcknUri, FirstnameUri, IlkoduUri, LastnameUri, AdresUri, UlkeUri];
	ODataQuery *query = [self getQueryForRelativePath:relativePath];
	return query;
}
...
- (ODataQuery *)getIT_ITEMSEntryQueryWithFiloSegment:(NSString *)FiloSegment andJatoModel:(NSString *)JatoModel andJatoMarka:(NSString *)JatoMarka andPlakaNo:(NSString *)PlakaNo andSasiNo:(NSString *)SasiNo andAracRenk:(NSString *)AracRenk andCKislastik:(NSString *)CKislastik andFiyat:(NSString *)Fiyat andKampanyaId:(NSString *)KampanyaId andSatisBurosu:(NSString *)SatisBurosu andTeslimSubesi:(NSString *)TeslimSubesi andAlisSubesi:(NSString *)AlisSubesi andAracGrubu:(NSString *)AracGrubu andMiktar:(NSString *)Miktar andMalzemeNo:(NSString *)MalzemeNo andRezKalemNo:(NSString *)RezKalemNo
{
	...
	NSString *relativePath = [NSString stringWithFormat:@"IT_ITEMS(FiloSegment=%@,JatoModel=%@,JatoMarka=%@,PlakaNo=%@,SasiNo=%@,AracRenk=%@,CKislastik=%@,Fiyat=%@,KampanyaId=%@,SatisBurosu=%@,TeslimSubesi=%@,AlisSubesi=%@,AracGrubu=%@,Miktar=%@,MalzemeNo=%@,RezKalemNo=%@)", FiloSegment, JatoModel, JatoMarka, PlakaNo, SasiNo, AracRenk, CKislastik, Fiyat, KampanyaId, SatisBurosu, TeslimSubesi, AlisSubesi, AracGrubu, Miktar, MalzemeNo, RezKalemNo];
	ODataQuery *query = [self getQueryForRelativePath:relativePath];
	return query;
}
...
- (ODataQuery *)getIT_ITEMSEntryQueryTypedWithFiloSegment:(NSString *)FiloSegment andJatoModel:(NSString *)JatoModel andJatoMarka:(NSString *)JatoMarka andPlakaNo:(NSString *)PlakaNo andSasiNo:(NSString *)SasiNo andAracRenk:(NSString *)AracRenk andCKislastik:(NSString *)CKislastik andFiyat:(NSDecimalNumber *)Fiyat andKampanyaId:(NSString *)KampanyaId andSatisBurosu:(NSString *)SatisBurosu andTeslimSubesi:(NSString *)TeslimSubesi andAlisSubesi:(NSString *)AlisSubesi andAracGrubu:(NSString *)AracGrubu andMiktar:(NSDecimalNumber *)Miktar andMalzemeNo:(NSString *)MalzemeNo andRezKalemNo:(NSString *)RezKalemNo
{
	...
	NSString *relativePath = [NSString stringWithFormat:@"IT_ITEMS(FiloSegment=%@,JatoModel=%@,JatoMarka=%@,PlakaNo=%@,SasiNo=%@,AracRenk=%@,CKislastik=%@,Fiyat=%@,KampanyaId=%@,SatisBurosu=%@,TeslimSubesi=%@,AlisSubesi=%@,AracGrubu=%@,Miktar=%@,MalzemeNo=%@,RezKalemNo=%@)", FiloSegmentUri, JatoModelUri, JatoMarkaUri, PlakaNoUri, SasiNoUri, AracRenkUri, CKislastikUri, FiyatUri, KampanyaIdUri, SatisBurosuUri, TeslimSubesiUri, AlisSubesiUri, AracGrubuUri, MiktarUri, MalzemeNoUri, RezKalemNoUri];
	ODataQuery *query = [self getQueryForRelativePath:relativePath];
	return query;
}
...
{
	RVbeln = [ODataQuery encodeURLParameter:RVbeln];
	RPosnr = [ODataQuery encodeURLParameter:RPosnr];
	RGjahr = [ODataQuery encodeURLParameter:RGjahr];
	RAuart = [ODataQuery encodeURLParameter:RAuart];
	Matnr = [ODataQuery encodeURLParameter:Matnr];
	Kunnr = [ODataQuery encodeURLParameter:Kunnr];
	Hdfsube = [ODataQuery encodeURLParameter:Hdfsube];
	Augru = [ODataQuery encodeURLParameter:Augru];
	Vkorg = [ODataQuery encodeURLParameter:Vkorg];
	Vtweg = [ODataQuery encodeURLParameter:Vtweg];
	Spart = [ODataQuery encodeURLParameter:Spart];
	GrupKodu = [ODataQuery encodeURLParameter:GrupKodu];
	NSString *relativePath = [NSString stringWithFormat:@"IT_SDREZERV(RVbeln=%@,RPosnr=%@,RGjahr=%@,RAuart=%@,Matnr=%@,Kunnr=%@,Hdfsube=%@,Augru=%@,Vkorg=%@,Vtweg=%@,Spart=%@,GrupKodu=%@)", RVbeln, RPosnr, RGjahr, RAuart, Matnr, Kunnr, Hdfsube, Augru, Vkorg, Vtweg, Spart, GrupKodu];
	ODataQuery *query = [self getQueryForRelativePath:relativePath];
	return query;
}
...
{
	id <URITypeConverting> converter = [ODataURITypeConverter uniqueInstance];
	NSString *RVbelnUri = [ODataQuery encodeURLParameter:[converter convertToEdmStringURI:RVbeln]];
	NSString *RPosnrUri = [ODataQuery encodeURLParameter:[converter convertToEdmStringURI:RPosnr]];
	NSString *RGjahrUri = [ODataQuery encodeURLParameter:[converter convertToEdmStringURI:RGjahr]];
	NSString *RAuartUri = [ODataQuery encodeURLParameter:[converter convertToEdmStringURI:RAuart]];
	NSString *MatnrUri = [ODataQuery encodeURLParameter:[converter convertToEdmStringURI:Matnr]];
	NSString *KunnrUri = [ODataQuery encodeURLParameter:[converter convertToEdmStringURI:Kunnr]];
	NSString *HdfsubeUri = [ODataQuery encodeURLParameter:[converter convertToEdmStringURI:Hdfsube]];
	NSString *AugruUri = [ODataQuery encodeURLParameter:[converter convertToEdmStringURI:Augru]];
	NSString *VkorgUri = [ODataQuery encodeURLParameter:[converter convertToEdmStringURI:Vkorg]];
	NSString *VtwegUri = [ODataQuery encodeURLParameter:[converter convertToEdmStringURI:Vtweg]];
	NSString *SpartUri = [ODataQuery encodeURLParameter:[converter convertToEdmStringURI:Spart]];
	NSString *GrupKoduUri = [ODataQuery encodeURLParameter:[converter convertToEdmStringURI:GrupKodu]];
	NSString *relativePath = [NSString stringWithFormat:@"IT_SDREZERV(RVbeln=%@,RPosnr=%@,RGjahr=%@,RAuart=%@,Matnr=%@,Kunnr=%@,Hdfsube=%@,Augru=%@,Vkorg=%@,Vtweg=%@,Spart=%@,GrupKodu=%@)", RVbelnUri, RPosnrUri, RGjahrUri, RAuartUri, MatnrUri, KunnrUri, HdfsubeUri, AugruUri, VkorgUri, VtwegUri, SpartUri, GrupKoduUri];
	ODataQuery *query = [self getQueryForRelativePath:relativePath];
	return query;
}
