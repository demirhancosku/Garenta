...
{
    [super viewDidLoad];
    [[self tableView] setSeparatorColor:[ApplicationProperties getMenuTableBackgorund]];
    [[self tableView] setBackgroundColor:[ApplicationProperties getMenuTableBackgorund]];
