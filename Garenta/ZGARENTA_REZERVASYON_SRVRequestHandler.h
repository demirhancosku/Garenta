...
extern NSString * const kLoadET_KK_RETURNSetForReservationServiceCompletedNotification; ///< Notification key for complete loading of ET_KK_RETURNSet navigation items for a specific ReservationService item.
...
/**
 Load the ET_KK_RETURNSet navigation items for a specific ReservationService item, parsed into ET_KK_RETURN objects. 
 May send notifications with the following keys and associated objects (as userInfo dictionary):
 - kLoadET_KK_RETURNSetForReservationServiceCompletedNotification for operation completion, along with the ReservationService item given as parameter (for kResponseParentItem key), and the array of the ET_KK_RETURN items (for kResponseItems key) or parsing error (for kParsingError key) or server response error (for kServerResponseError).
 - kAuthenticationNeededNotification for request authentication challenge.
 @param aReservationService The specific item to load its ET_KK_RETURNSet navigation items.
 */
...
/**
 Creates a ET_KK_RETURN item for a ReservationService item (using ET_KK_RETURNSet navigation query).
 May send notifications with the following keys and associated objects (as userInfo dictionary):
 ...
 - kAuthenticationNeededNotification for request authentication challenge.
 @param aNewET_KK_RETURN The specific item to create.
 @param aReservationService The item which the created item will be associated to.
 */
